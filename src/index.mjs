...
const PRODUCT = {
  "repo": "cyberark-privilege-evidence-ledger",
  "vendor": "CyberArk",
  "title": "privilege evidence ledger",
  "domain": "IAM / Privileged Access",
  "audience": "CISOs, PAM owners, identity governance teams, and audit leaders",
  "problem": "Privileged access creates board-visible exposure when safe ownership, session risk, rotation evidence, and exceptions are not reviewable.",
  "workflow": "The product maps privileged accounts, safes, session posture, rotation gaps, and exception ownership into one evidence ledger.",
  "business": "Leaders can prioritize high-risk privilege cleanup, reduce audit scramble, and justify PAM investment with concrete exposure data.",
  "technical": "Synthetic PAM lanes are scored deterministically and rendered as a static privileged-access brief.",
  "integration": "CyberArk safes, privileged accounts, session logs, credential rotation, ownership maps, and exception tickets.",
  "keywords": [
    "CyberArk",
    "PAM",
    "privileged access",
